...
public class MeetingDto {
	...
	private int b_no, b_view, b_reply, b_recommend, member_no, cat_no, backend, backend_apply, frontend, frontend_apply,
			server, server_apply, pm, pm_apply, apply, apply_max, meeting_tmp;
	private String b_title, b_content, meet_topic_name, meet_state, meet_field, meet_tags, member_id, meeting_position;
