...
<%-- 						<div class="board_number">${dto.b_no}</div> --%>
			...
			<form
				action="${pageContext.request.contextPath}/qna/qna_detail?b_no=${dto.b_no}&pg=${pg}"
				method="post">
			...
			<script type="text/javascript">
				function board_update() {
					//alert("수정");
					location.href = "qna_update_form?b_no=${dto.b_no}";
				}

				function board_delete() {
					// 		alert("삭제");
					// 		location.href = "/qna_delete/${dto.b_no}";
				...
				function board_reply() {
					...
					// 		location.href = "/qna/qna_detail?b_no=${dto.b_no}";
				}
									...
									$("form")
											.on(
													...
													function(event) {
														...
														$
																.ajax({
																	url : "${pageContext.request.contextPath}/qna/${dto.b_no}/replies",
																	type : "POST",
																	data : formData,
																	dataType : "json",
																	success : function(
