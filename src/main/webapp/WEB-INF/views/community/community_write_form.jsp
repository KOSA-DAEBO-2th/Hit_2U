...
<body>
	<main class="main_content_sm">
		<div class="content_label">
			<div class=" font_30">커뮤니티 게시판 글 작성</div>
			<div class="font_gray font_14">커뮤니티 게시판에 글을 등록하세요.</div>
		</div>
		<form id="meeting_insert" action="/community/write" method="post"
			...
			<div class="write_wrap padding_bottom_20">
				...
				<div class="input_section radio">
					<input type="radio" class="btn-check" name="topic_no"
						id="vbtn-radio1" autocomplete="off" checked value="3"> <label
						class="btn btn-outline-primary margin_right_20" for="vbtn-radio1">자유</label>
						
					<input type="radio" class="btn-check" name="topic_no"
						id="vbtn-radio2" autocomplete="off" value="4"> <label
						class="btn btn-outline-primary margin_right_20" for="vbtn-radio2">고민</label>
						
					 <input
						type="radio" class="btn-check" name="topic_no" id="vbtn-radio3"
						autocomplete="off" value="5"> <label
						class="btn btn-outline-primary margin_right_20" for="vbtn-radio3">운동</label> 
						
					<input
						type="radio" class="btn-check" name="topic_no" id="vbtn-radio4"
						autocomplete="off" value="6"> <label
						class="btn btn-outline-primary" for="vbtn-radio4">익명</label>
				</div>
