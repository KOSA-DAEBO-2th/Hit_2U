...
class="btn btn_category btn_category_click">전체</button>
	<a href="/category2?topic_no=11" class="btn btn_category">커리어</a> <a
		href="/category2?topic_no=12" class="btn btn_category">기술</a> <a
		href="/category2?topic_no=13" class="btn btn_category">알고리즘</a> <a
		href="/category2?topic_no=14" class="btn btn_category btn_anonymous">기타</a>
</div>
